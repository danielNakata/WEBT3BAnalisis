      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="login.html">Categorias</a>
            <a class="dropdown-item" href="register.html">Proveedores</a>
            <a class="dropdown-item" href="forgot-password.html">Productos</a>
            <div class="dropdown-divider"></div>
            <h6 class="dropdown-header">Almacén</h6>
            <a class="dropdown-item" href="404.html">Inventario</a>
            <a class="dropdown-item" href="blank.html">StockOut</a>
            <a class="dropdown-item" href="blank.html">SobreStock</a>
            <a class="dropdown-item" href="blank.html">Merma</a>
            <a class="dropdown-item" href="blank.html">Picking</a>
          </div>
        </li>
