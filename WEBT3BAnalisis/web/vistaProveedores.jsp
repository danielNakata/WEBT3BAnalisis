...
<html lang="es">
    <head>
        ...
        <title>.:T3B Analisis Compras:. Vista por Proveedores <%= usuarioJSON.getString("ulogin") + " " + usuarioJSON.getString("unombre") + " " + usuarioJSON.getString("uapellidop")%></title>
    ...
    <body onload="cargaDashboardTableau2('DPzsRegionesxProv', 'divgraficaProveedores')">
        <header>
            ...
            <div class="navbar navbar-dark bg-dark shadow-sm">
                <div class="container d-flex justify-content-between">
                    <a href="#" class="navbar-brand d-flex align-items-center">
                        <strong>T3B Análisis: Proveedores</strong>
                    </a>
            ...
            <section class="jumbotron text-center">
                <div class="container">
                    <p>
                        ...
                        <a href="vistaProveedores.jsp" class="btn btn-primary2 my-2">Vista por Proveedores</a>
                    </p>
                </div>
                <div class="container">
                    <h4 class="jumbotron-heading">Opciones</h4>
                    <p>
                        <a href="#" onclick="cargaDashboardTableau2('DPzsRegionesxProv', 'divgraficaProveedores')" class="btn btn-secondary my-2">Proveedor</a>
                        <a href="#" onclick="cargaDashboardTableau2('DPzsRegionesxProv2', 'divgraficaProveedores')" class="btn btn-secondary my-2">Producto</a>
                    </p>
                </div>
            </section>

            <div id="divgraficaProveedores" style="height: auto; width: 80%; padding: 0px; margin-left: 10%;">
