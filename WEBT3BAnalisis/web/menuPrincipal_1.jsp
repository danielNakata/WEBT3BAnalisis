            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="#"><%= usuarioJSON.getInt("useq") +" - " + usuarioJSON.getString("unombre") + " " + usuarioJSON.getString("uapellidop")  %></a>
                        <a class="dropdown-item" href="#">Opciones</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="index.jsp" data-toggle="modal" data-target="#logoutModal">Salir</a>
                    </div>
                </li>
            </ul>
