...
<html lang="es">
    <head>
        ...
        <title>.:T3B Analisis Compras:. Vista por Regiones<%= usuarioJSON.getString("ulogin") + " " + usuarioJSON.getString("unombre") + " " + usuarioJSON.getString("uapellidop")%></title>
    ...
    <body onload="cargaDashboardTableau2('DPzsTipoxRegion', 'divgraficaRegion')">
        <header>
            ...
            <div class="navbar navbar-dark bg-dark shadow-sm">
                <div class="container d-flex justify-content-between">
                    <a href="#" class="navbar-brand d-flex align-items-center">
                        <strong>T3B Análisis: Regiones</strong>
                    </a>
        ...
        <main role="main">
            <section class="jumbotron text-center">
                <div class="container">
                    <p>
                        <a href="vistaRegional.jsp" class="btn btn-primary2 my-2">Vista por Regiones</a>
                        <a href="vistaCategorias.jsp" class="btn btn-secondary my-2">Vista por Categorias</a>
                ...
                <div class="container">
                    ...
                    <p>
                        <a href="#" onclick="cargaDashboardTableau2('DPzsTipoxRegion', 'divgraficaRegion')" class="btn btn-secondary my-2">Region</a>
                        <a href="#" onclick="cargaDashboardTableau2('DPzsTipoxRegion2', 'divgraficaRegion')" class="btn btn-secondary my-2">Region y Tipo de Producto</a>
                        <a href="#" onclick="cargaDashboardTableau2('DPzsTipoxRegion3', 'divgraficaRegion')" class="btn btn-secondary my-2">Region y Producto</a>
                    </p>
                </div>
            </section>
        </main>

        <div id="divgraficaRegion" style="height: auto; width: 80%; padding: 0px; margin-left: 10%;">
