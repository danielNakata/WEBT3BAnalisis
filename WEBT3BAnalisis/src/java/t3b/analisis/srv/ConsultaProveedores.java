 ...
 * @author danie
 */
public class ConsultaProveedores extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(conn != null){
                QryRespDTO resp = new Consulta().ejecutaSelectSP(conn, IQry.TAL_CONSULTAPROVEEDORES, null);
                ...
                if(resp.getRes() == 1){
                    ...
                    if(cols != null){
                        ...
                        grupoJSON = ",\"proveedores\": ["+grupoJSON.substring(1)+"]";
                        salidaJSON = "{\"res\":\"1\", \"msg\":\"CATALOGO DE PROVEEDORES OBTENIDOS\""+grupoJSON+"}";
                    }
                }
            }
        }catch(Exception ex){
