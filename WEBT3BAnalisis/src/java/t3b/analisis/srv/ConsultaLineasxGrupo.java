 ...
 * @author danie
 */
public class ConsultaLineasxGrupo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            paIdGrupo = request.getParameter("paIdGrupo").split("-")[0];
            ...
            if(conn != null){
                ...
                if(resp.getRes() == 1){
                    ...
                    if(cols != null){
                        ...
                        grupoJSON = ",\"grupos\": ["+grupoJSON.substring(1)+"]";
                        salidaJSON = "{\"res\":\"1\", \"msg\":\"CATALOGO DE GRUPOS OBTENIDOS\""+grupoJSON+"}";
                    }
                }
            }
        }catch(Exception ex){
