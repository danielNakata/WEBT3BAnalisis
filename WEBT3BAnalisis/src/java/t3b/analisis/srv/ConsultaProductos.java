 ...
 * @author danie
 */
public class ConsultaProductos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            paOpt = request.getParameter("paOpt");
            paFiltro = request.getParameter("paFiltro");
            ...
            if(conn != null){
                ...
                paramsIn.add(paOpt);
                paramsIn.add(paFiltro);
                QryRespDTO resp = new Consulta().ejecutaSelectSP(conn, IQry.TAL_CONSULTALINEASXGRUPO, paramsIn);
                ...
                if(resp.getRes() == 1){
                    ...
                    if(cols != null){
                        ...
                        grupoJSON = ",\"productos\": ["+grupoJSON.substring(1)+"]";
                        salidaJSON = "{\"res\":\"1\", \"msg\":\"CATALOGO DE PRODUCTOS OBTENIDOS\""+grupoJSON+"}";
                    }
                }
            }
        }catch(Exception ex){
